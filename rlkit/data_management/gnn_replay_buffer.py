...
class GNNReplayBuffer(ReplayBuffer):
    ...
    def __init__(
        ...
        self._observations = np.array([None] * max_replay_buffer_size, dtype='O')
        # It's a bit memory inefficient to save the observations twice,
        # but it makes the code *much* easier since you no longer have to
        # worry about termination conditions.
        self._next_obs = np.array([None] * max_replay_buffer_size, dtype='O')
        self._actions = np.zeros((max_replay_buffer_size, action_dim, action_feature_dim)) 
